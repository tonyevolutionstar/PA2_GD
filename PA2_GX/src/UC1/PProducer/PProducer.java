            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(ThreadStatus, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
                        ...
                        String str = dataInputStream2.readUTF();                    
                            ...
                            for(String a: arrOfStr)
                            {
                                if(!a.isBlank())
                                {
                                    ...
                                    ThreadStatus.setText(a);   
                                    System.out.println(a);
                                }                        
                            }

                    } catch (IOException ex) {
                        Logger.getLogger(PProducer.class.getName()).log(Level.INFO, null, ex);
                        try {
                            s2.close();
                            ThreadStatus.setText("Lost Connection!");
                        } catch (IOException ex1) {
                            Logger.getLogger(PProducer.class.getName()).log(Level.SEVERE, null, ex1);
                        }
                    }
                }  
            }
